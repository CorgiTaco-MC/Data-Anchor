...
public class AStar {
    ...
    private void checkNode(Node currentNode, int col, int row, int cost) {
        ...
        if (!adjacentNode.isBlock().getBoolean(currentNode) && !getClosedSet().contains(adjacentNode)) {
    ...
    public void setBlock(int row, int col, Object2BooleanFunction<Node> booleanFunction) {
        this.searchArea[row][col].setBlock(booleanFunction);
    }
